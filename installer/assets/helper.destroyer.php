    ...
    *  ================================================================= */
    ...
    function DeleteYourself()
    {
        ...
        */
        ...
        $fileDelete = ['success' => 0, 'failed' => 0, 'total' => count($files)];
        $dirDelete = ['success' => 0, 'failed' => 0, 'total' => count($dirs)];
        ...
        return ['dirs' => $dirDelete, 'files' => $fileDelete];
    }
     ...
     *  in the read.
     */
    function ReadFiles($dir, $filterExt = [])
    {
        $files = [];
        $checkFile = '';
        $extension = '';
                ...
                while (($checkFile = readdir($opendir))) {
                    ...
                    if ($extension !== false && (count($filterExt) == 0 || in_array($extension, $filterExt))) {
                        ...
                        if (filetype($dir.'/'.$checkFile) == 'file') {
                            ...
                            $files[] = ['scope' => $scope, 'dir' => $dir, 'name' => $checkFile, 'ext' => $extension];
                        }
                    }
                }
                closedir($opendir);
