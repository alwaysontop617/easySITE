...
if (!defined('INST_BASEDIR')) {
    ...
    *  ================================================================= */
    ...
    class Inst_Databases
    {
         ...
         *  Connects to database and executes queries.
         */
        public function Inst_Databases()
        {
        ...
        public function RunQuery($query)
        {
            if (is_array($query)) {
                ...
                foreach ($query as $q) {
                    ...
                    if ($result) {
                        $results[] = ['success' => true,  'data' => $result, 'error' => ''];
                    } else {
                        $results[] = ['success' => false, 'data' => $result, 'error' => $this->GetDatabaseError()];
                    }
                }
         ...
         */
        public function IsDatabaseFriendly($database)
        {
         ...
         */
        public function GetDatabaseList($includeSelectedDatabase = true)
        {
            /*
         ...
         */
        public function GetTableListFromDatabase()
        {
        ...
        public function TestUserPrivileges()
        {
            ...
            foreach ($testing as $test => $query) {
                $result = $this->RunQuery($query);
                if ($result) {
                    $outcome[$test] = ['success' => true,  'query' => $query, 'error' => ''];
                } else {
                    $totalSuccess = false;
                    $outcome[$test] = ['success' => false, 'query' => $query, 'error' => $this->GetDatabaseError()];
                }
            }
