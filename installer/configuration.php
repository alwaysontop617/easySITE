...
if (!defined('INST_BASEDIR')) {
    ...
    *  ================================================================= */
    ...
    \---------------------------------------------------------------------*/
    STEP_WELCOME => [
        'title'        => 'Welcome to the Installer of easySITE',
        'enabled'      => true,
    ...
    \---------------------------------------------------------------------*/
    STEP_PHPREQUIRES => [
        'title'       => 'Requirements of easySITE Software',
        'enabled'     => true,
    ...
    \--------------------------------------------------------------------*/
    'self_destruct_filter'          => [],
    'self_destruct_removes_folders' => dalse,
    ...
    'special' => [
        ...
        'company' => 'Tecflare',
        'product' => 'easySITE',
        'version' => file_get_contents('latest'),
